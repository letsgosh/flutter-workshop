...
class Notice extends StatelessWidget {
  ...
  Notice(this._img, this._title, this._date, this._description, this._category,
      this._link, this._origin, this.animationController);
    ...
    return new Container(
      ...
      child: new Row(
        ...
        children: <Widget>[
          new Hero(
            tag: _title,
            child: _getImgWidget(_getImageUrl(_img, 200, 200)),
          ),
